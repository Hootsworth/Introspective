        ...
        <div style={{ marginTop: "16px" }}>
          ...
          <div
            style={{
              ...
              borderRadius: "8px",
              marginBottom: "16px",
              background: results.overall_pass ? "rgba(16, 185, 129, 0.1)" : "rgba(226, 194, 117, 0.1)",
              border: `1px solid ${results.overall_pass ? "rgba(16, 185, 129, 0.3)" : "rgba(226, 194, 117, 0.3)"}`,
              color: results.overall_pass ? "#10b981" : "#e2c275",
              fontWeight: 600,
              fontSize: "13.5px",
              display: "flex",
              alignItems: "center",
